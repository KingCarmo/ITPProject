...
<head>
    <script>
        ...
        //Tabs on the cocktail page saying which genre the cocktails are. Also lines 73-79 are taken from the same page.
        //The tabs were changed from city names to out cocktail difficulty level.
...
<body>
    ...
    <?php $servername="mysql4.gear.host" ; $username="cock" ; $password="cocktails123!" ; // Create connection $conn=n ew mysqli($servername, $username, $password); // Check connection if ($conn->connect_error) { die("Connection failed: " . $conn->connect_error); } ?>
        ...
        <div class="header1">
            <div class="nav">
                <div class="designed">
                    ...
                    <center><img src="Pictures/Logo.png" alt="logo" style="width:1080px;height:500px;">
                    </center>
                                    ...
                                    <div class="modal-body">
                                        <div class="Paragraph">
                                            <center>
                                                ...
                                                <p><b>Ingredients:</b>
                                                    <br> 1.5 oz Gin
                                                    <br> 0.5 oz Lime juice
                                                    <br> 0.5 oz Simple syrup
                                                    <br> Fresh Lime
                                                    <br>
                                                </p>
                                                <p><b>Instructions:</b>
                                                    <br> Add 1.5 oz of the best Gin you can afford, 0.5 oz of fresh Lime Juice, and 0.5 oz Simple Syrup (made by boiling sugar and water) into pre-filled- with-ice Cocktail shaker. Shake like your life depends on it. Pour into a pre- chilled Cocktail glass. Garnish with a fresh lime and last but most imprtantly
                                                    <br>
                                                    <b>ENJOY!</b>
                                                </p>
                                ...
                                <div class="modal-body">
                                    <div class="Paragraph">
                                        <center>
                                            <h2>Cosmopolitan</h2>
                                            <p><b>Ingredients:</b>
                                                <br> 1.5 oz Vodka Citron
                                                <br> 0.5 oz Cointreau
                                                <br> 1 oz Cranberry juice
                                                <br> 0.5 oz Fresh Lime Juice
                                                <br> Fresh Lime
                                                <br>
                                            </p>
                                            <p><b>Instructions:</b>
                                                <br> Pour your Cointreau and cranberry juice into you gleaming cocktail shaker. Then add the lime juice and cranberry juice before topping it off with your finest cheap vodka citron. Add your ice and do the shaking thing. We all know thats the most fun part Pour your freshly made cocktail into a chilled glass, garnish with a lime and then all you do is
                                                <br>
                                                <b>ENJOY!</b>
                                                <br>
                                            </p>
                                ...
                                <div class="modal-body">
                                    <div class="Paragraph">
                                        <center>
                                            ...
                                            <p><b>Ingredients:</b>
                                                <br> 2 oz White Rum
                                                <br> 0.5 oz Grapefruit Juice
                                                <br> 0.5 oz Maraschino liqueur
                                                <br> Fresh Lime
                                                <br>
                                            </p>
                                            <p><b>Instructions:</b>
                                                <br> I'm sure you're starting to get the drill by now. Add your lush grapefruit juice on top of your probably barely-affordable Maraschino liqueur. Your white rum goes in next, like the boss it is. You put your frozen water (A.K.A 'ice') into your shaker and then user your shaker as a maraca and go nuts. Then do the easiest bit of all, and also the best -
                                                <br>
                                                <b>ENJOY!</b>
                                                <br>
                                            </p>
                                ...
                                <div class="modal-body">
                                    <div class="Paragraph">
                                        <center>
                                            ...
                                            <p><b>Ingredients:</b>
                                                <br> 1 oz Gin
                                                <br> 1 oz Sweet Red Vermouth
                                                <br> 1 oz Campari
                                                <br> Fresh Orange
                                                <br>
                                            </p>
                                            <p><b>Instructions:</b>
                                                <br> This one's is an easy one, but take nothing away from it, its tasty. You know the drill Pour your one ounce of gin, your one ounce of Sweet Red and your one ounce campari all into your sweet cocktail shaker. Shake shake shake. Put in the glass. Garnish. Then last but not by no means least-
                                                <br>
                                                <b>ENJOY!</b>
                                                <br>
                                            </p>
                                ...
                                <div class="modal-body">
                                    <div class="Paragraph">
                                        <center>
                                            ...
                                            <p><b>Ingredients:</b>
                                                <br> 2 oz Cognac
                                                <br> 0.75 oz Lemon Juice
                                                <br> 0.75 oz triple sec
                                                <br>
                                            </p>
                                            <p><b>Instructions:</b>
                                                <br> You will NEVER believe what you have to do for this one. Its a game changer. So, what you do is put your Cognac in a cocktail shaker (WOW!). Put your lemon juice into the cocktail shaker (NO WAY!). Add your triple sec into the very same cocktail shaker (I DONT BELIEVE IT!). Then guess what you do, you shake it. Shake again. Do it once more just to be safe. Then strain into a cocktail glass and as always -
                                                <br>
                                                <b>ENJOY!</b>
                                                <br>
                                            </p>
                                ...
                                <div class="modal-body">
                                    <div class="Paragraph">
                                        <center>
                                            <h2>Blue Coconut</h2>
                                            <p><b>Ingredients:</b>
                                                <br> 1 oz Blue Curacao
                                                <br> 1 oz Malibu Rum
                                                <br> 1 oz Passion fruit Rum
                                                <br> 3 oz Coconut Water
                                                <br> 1 oz Sprite
                                                <br> Simple Syrup
                                                <br> Granulated Sugar
                                                <br>
                                            ...
                                            <p><b>Instructions:</b>
                                                <br> You will need two plates to complete this cocktail. Pour sugar and syrup on to two sepreate plates. Take your glassware and dip the rims into first the syrup and then the sugar and then set your glass two one side. Now do your usual and add all your ingredients into a cocktail shaker with ice. Then do your now well-practiced shaking technique and shake the life out of your shaker. Then, as per usual, -
                                                <br>
                                                <b>ENJOY!</b>
                                                <br>
                                            </p>
                                ...
                                <div class="modal-body">
                                    <div class="Paragraph">
                                        <center>
                                            ...
                                            <p><b>Ingredients:</b>
                                                <br> 2 oz Cake favoured Vodka
                                                <br> 2 oz Coconut rum
                                                <br> 2 oz Pineapple juice
                                                <br> 2 oz Orange Juice
                                                <br> Club Soda
                                                <br> *optional*: Simple Syrup, Maraschino cherries, sprinkles, pineaplle and orange slices
                                                <br>
                                            </p>
                                            <p><b>Instructions:</b>
                                                <br> The usual, add your Vodka, rum and two juices into a cocktail shaker with ice. If you want to dilute the cocktail a little bit, go ahead and add your club soda. To garnish, use a cherry and/or wedges of pineapple and orange. To make a f Pour your freshly made cocktail into a chilled glass, garnish with a lime and then all you do is
                                                <br>
                                                <b>ENJOY!</b>
                                                <br>
                                            </p>
                                ...
                                <div class="modal-body">
                                    <div class="Paragraph">
                                        <center>
                                            ...
                                            <p><b>Ingredients:</b>
                                                <br> 1 refrigerated bottle dry white wine
                                                <br> 1.5 oz Granulated Sugar/Honey
                                                <br> 2 oz Pineapple juice
                                                <br> 2 oz Orange Juice
                                                <br> Club Soda
                                                <br> *optional*: Simple Syrup, Maraschino cherries, sprinkles, pineaplle and orange slices
